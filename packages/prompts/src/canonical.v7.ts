/**
 * Prompt canónico v7 (spec v2, 6.3). La v6 dejaba que el panorama se escribiera como una
 * enumeración: pedido "Dame las noticias políticas de Uruguay", el modelo devolvió las ocho notas
 * encadenadas con punto y coma dentro de una sola oración. El verificador de sustento de Bedrock
 * mide por unidad, y una oración que junta ocho hechos de ocho notas distintas no la sustenta
 * ninguna: medido contra el guardrail el 15/9/2026, ese texto dio 0,06 y los mismos hechos
 * escritos en prosa dieron 0,80. El lector terminaba viendo "no pude armar un resumen" sobre una
 * respuesta correcta. La regla 17 fija la forma.
 *
 ...
 */
export const CANONICAL_SYSTEM_V7 = `Actuás como editor de El País (Uruguay). Respondés preguntas de lectores usando
...
export const CANONICAL_STRICT_SUFFIX_V7 = `
