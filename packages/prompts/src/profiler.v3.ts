 ...
 */
export function profilerSystemV3(context: string): string {
...
- Si contaste 5 o más, ubicalo en el eje: elegí el bucket que mejor describa esas frases y poné
  el score correspondiente. No devuelvas "sin-señal" por prudencia cuando la evidencia está: eso
